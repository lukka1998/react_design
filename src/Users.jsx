...
import reactLogo from './assets/grow_together2.png'
        ...
        <div style={{textAlign:"center",marginTop:"50px"}}>
            ...
            <foreignObject x="80" y="250" width="1740" height="1000">
                <div style={{display:"flex",gap:"200px" , alignItems:"center"}}>
                    <div>
                        <div style={{color: '#00252E', fontFamily: 'Poppins, sans-serif', fontSize: '40px', fontStyle: 'normal', fontWeight: 700, lineHeight: '60px', textAlign:"left" }}>Your Users</div>
                        <div style={{display: 'flex', justifyContent:"flex-start" , color: '#00252E', width:"520px",fontFamily: 'Open Sans, sans-serif',fontSize: '20px',fontStyle: 'normal',fontWeight: 200,lineHeight: '36px', textAlign:"left" }}>It takes no time at all to integrate Huddle with your app's authentication solution. This means, once signed in to your app, your users can start chatting immediately.</div>
